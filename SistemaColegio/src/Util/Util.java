...
public class Util {
    ...
    public static void AplicarIcono(JFrame formulario) {
        formulario.setIconImage(Toolkit.getDefaultToolkit().getImage(formulario.getClass().getResource("/Iconos/sistema.jpg")));
    }

    public static void AplicarIcono(JDialog formulario) {
        formulario.setIconImage(Toolkit.getDefaultToolkit().getImage(formulario.getClass().getResource("/Iconos/sistema.jpg")));
    }
    ...
    public static void AplicarEncabezado(JDialog formulario, JLabel encabezado, String iconoEncabezado, String titulo, String subtitulo) {
        ...
        cadena = cadena + "<tr>";
        cadena = cadena + "<td>";
        cadena = cadena + "<img src='" + formulario.getClass().getResource("/Iconos/" + iconoEncabezado + ".png") + "'>";
        cadena = cadena + "</td>";
        cadena = cadena + "<td>";
    ...
    public static void AplicarSubencabezado(JDialog formulario, JLabel subencabezado, String iconoSubencabezado, String titulo) {
        ...
        cadena = cadena + "<tr>";
        cadena = cadena + "<td>";
        cadena = cadena + "<img src='" + formulario.getClass().getResource("/Iconos/" + iconoSubencabezado + ".png") + "'>";
        cadena = cadena + "</td>";
        cadena = cadena + "<td>";
